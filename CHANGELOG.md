...
* **ci:** upgrade Node.js version from 22 to 24 LTS in GitHub Actions workflows
* **deps:** update Node.js requirement to version 24 LTS for improved performance and latest features
* **ci:** fix YAML indentation issues in bump-version.yml workflow to resolve GitHub Actions validation errors

### Documentation

* **memory-bank:** update tech context and environment documentation to reflect Node.js 24 upgrade
* **progress:** document Node.js 24 migration as completed recent work

## [0.5.6](https://github.com/sm-moshi/aimemory/compare/v0.5.5...v0.5.6) (2025-05-23)

## [0.5.5](https://github.com/sm-moshi/aimemory/compare/v0.5.4...v0.5.5) (2025-05-23)

## [0.5.4](https://github.com/sm-moshi/aimemory/compare/v0.5.3...v0.5.4) (2025-05-23)

## [0.5.3](https://github.com/sm-moshi/aimemory/compare/v0.5.2...v0.5.3) (2025-05-22)

## [0.5.2](https://github.com/sm-moshi/aimemory/compare/v0.5.1...v0.5.2) (2025-05-22)

## [0.5.1](https://github.com/sm-moshi/aimemory/compare/v0.4.6...v0.5.1) (2025-05-19)
...
## [0.4.2](https://github.com/sm-moshi/aimemory/compare/v0.4.1...v0.4.2) (2025-05-19)
