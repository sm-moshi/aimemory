...
describe("UpdateMemoryBankFileSchema Validation", () => {
...
describe("validateMCPToolParams Schema Validation", () => {
...
describe("sanitizePath Security Validation", () => {
	...
	it("should reject path traversal attempts", () => {
		expect(() => sanitizePath("../dangerous")).toThrow();
		expect(() => sanitizePath("valid/../dangerous")).toThrow();
	});

	it("should reject null bytes", () => {
		expect(() => sanitizePath("path\x00injection")).toThrow("Path contains null bytes");
	});
	...
	it("should prevent escaping allowedRoot", () => {
		expect(() => sanitizePath("../escape", "/test")).toThrow();
	});
});

describe("validateMemoryBankPath Security Validation", () => {
...
describe("validateCommand Security Validation", () => {
...
describe("validateCommandArgs Security Validation", () => {
...
describe("validateProcessConfig Security Validation", () => {
	...
	it("should reject invalid timeout", () => {
		...
		expect(() => validateProcessConfig(config)).toThrow("Timeout must be a positive number");
	});
});

describe("validatePort Security Validation", () => {
...
describe("sanitizeUserInput Security Validation", () => {
...
describe("sanitizeFileContent Security Validation", () => {
...
describe("auditInput Security Validation", () => {
