...
import type { DependencyFactory, Registration } from "../lib/types/system";
...
export class DIContainer {
	 ...
	 * @param key - The key or identifier for the dependency (e.g., a class name or interface
	 * identifier). @param factory - A function that creates the dependency instance. This function
	 * receives the container itself to resolve its own dependencies. @param singleton - If true,
	 * the factory will be called only once and the same instance will be returned on subsequent
	 * resolutions.
	 */
	 ...
	 * @param key - The key or identifier for the dependency. @returns The dependency instance.
