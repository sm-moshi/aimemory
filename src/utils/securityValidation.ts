...
import { PortNumberSchema, SafeCommandSchema, SafePathSchema } from "../types/validation.js";
	...
	if (allowedRoot) {
		...
		if (!resolvedPath.startsWith(`${resolvedRoot}/`) && resolvedPath !== resolvedRoot) {
			throw new ValidationError(
				...
				"PATH_OUTSIDE_ROOT",
				{ path: normalizedPath, root: allowedRoot },
			);
		}
	}
...
/**
 * Performs a security audit of a given input
 */
