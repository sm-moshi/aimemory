import type { MemoryBankError, MemoryBankFile, MemoryBankFileType, Result } from "./types/index.js";
import { isError, isSuccess } from "./types/index.js";
import type { CommandResult, MCPServerInterface } from "./types/mcpTypes.js";
...
function categorizeFilesByType(files: MemoryBankFile[]): Record<string, string[]> {
	...
	for (const file of files) {
		...
		const category = file.type.includes("/") ? file.type.split("/")[0] : "legacy";
