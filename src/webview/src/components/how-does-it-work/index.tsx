	...
	return (
		<div className="rounded-xl border border-border bg-muted p-4 shadow-sm space-y-4 mb-6">
			...
			<div className="flex flex-col gap-3">
				<p>
					AI Memory helps Cursor remember what matters in your project by storing key context (like your
					goals, architecture, and recent progress) in a structured set of Markdown files called the Memory
					Bank. This lets the AI stay grounded in your work, even across sessions.
				</p>
				<div className="flex flex-col gap-1">
					...
					<p>
						...
						patterns to make your project context persistent and queryable.
					</p>
					<p>
						To initialise it, type <code>"Initialise memory bank"</code> in Cursor (ideally using Claude 3.5
						or 3.7). For a deeper dive, read the Cline guide on{" "}
						<a
